//! MySQL/MariaDB schema and SQLx boundary for Carrier.
//!
//! MySQL and MariaDB remain separate support claims. The eventual adapter will
//! select and verify its dialect rather than treating one server as proof for
//! the other.
