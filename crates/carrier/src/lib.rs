//! Synchronous, runtime-free values for Carrier's transactional-outbox contract.
//!
...
pub use state::{
    ClaimToken, ClaimedEvent, DeliverySnapshot, DeliveryState, EnqueueOutcome, PagedEvent,
};
pub use value::{
