//! PostgreSQL schema and SQLx boundary for Carrier.
//!
//! This crate publishes versioned migration artifacts without applying them.
//! Transactional operations will remain concrete to PostgreSQL and will be
//! added after their locking, database-time, fencing, and rollback contracts
