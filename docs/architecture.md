...
leased worker or CDC. Per-stream publication ownership is not supported unless
a future first-class scoped-claim contract is added.
...
and use database-generated millisecond timestamps. The 0.1.1 backend and
