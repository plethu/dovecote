...
The local 0.2.0 release-candidate evidence from disposable backend instances
remains as recorded below. Cargo registry publication and package-registry
verification remain pending and are not claimed here. This is not a claim for
a neighbouring database release.
